...
### 2026-08-07 지도 홈·보관 마커·현재 위치 개선 — CI 통과
...
9분간 러너 대기했지만, 배정 뒤 앱 단계는 정상 완료했습니다. 이 변경은 **아직 TestFlight
29에는 포함되지 않았습니다.**
...
- **TestFlight 1.0 (29) 업로드 완료**. 최신 `main` 커밋 `270df35`까지 포함됩니다.
- TestFlight 실행 `31118478750` 3차 시도는 아카이브·업로드·CI 임시 인증서 회수까지
  통과했습니다.
...
**TestFlight 1.0 (29)을 App Store Connect에 업로드했습니다.** Apple 처리 완료 후
