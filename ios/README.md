...
보여 줍니다.
복수 후보 단계의 대표가 아직 없을 때 도보·대중교통·자전거를 먼저 골라도 선택 수단은
...
`장소 추가`·`손그림`만 아이콘과 글자를 함께 보여 주고, 되돌리기·전체 지우기·공유는
원형 아이콘만 표시합니다. 화면에서 글자를 없애도 VoiceOver용 기능 이름은 유지합니다.
...
실제 경로는 지도 도로에 묻히지 않도록 도보 7pt, 대중교통 9pt, 자전거 8pt로 그리고,
